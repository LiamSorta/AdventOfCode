    ...
    class Day4_part2
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                //////////////////////////////////////////////////////////////////////////////////////////////////////////
                /*                                                                                                      */
                /*  The ONLY change is |encoded.Substring(0, 5) != "00000"| to |encoded.Substring(0, 6) != "000000"|    */
                /*                                                                                                      */
                //////////////////////////////////////////////////////////////////////////////////////////////////////////

            } while (encoded.Substring(0, 6) != "000000"); //Checks to see if the first 6 chars of the encoded password are 000000
